...
require(RMySQL)
require(lubridate)
source('/root/etl/car_fun_online.R',encoding = 'utf8')
dbname_td = "t_d"
dbname_td_report = 't_d_report'
username="root"
password = 't2F81XGv5aKuRYUs'
host = '192.168.3.3'
#username="wangchao"
#password = 'juma9156'
#host = '10.101.0.13'
...
dbSendQuery(conn_td,'SET NAMES utf8')
...
(
  ...
  write.table(platenumber_dt,'/root/etl/data/summary_d_plate.csv',row.names = F,col.names = F,sep=',',na='') 
  ...
  write.table(cusinfo_dt,'/root/etl/data/summary_d_customer_info.csv',row.names = F,col.names = F,sep=',',na='') 
  ...
  write.table(orderdt,'/root/etl/data/summary_d_order_info.csv',row.names = F,col.names = F,sep=',',na='') 
  dbDisconnect(conn_td_report)
