#http://blog.revolutionanalytics.com/2014/06/constructing-a-continuous-futures-series-from-quandl.html
#https://quantstrattrader.wordpress.com/2014/07/22/intermission-a-data-file-for-futures-data-from-quandl/
#https://quantstrattrader.wordpress.com/2015/06/08/last-post-for-a-while-and-two-premium-cheap-databases/
#https://www.quandl.com/collections/futures
#https://github.com/IlyaKipnis/IKTrading


#copy from  https://github.com/IlyaKipnis/IKTrading
require(Quandl)
Quandl.auth('8z-Fi9CYwvbvDPXw8v4R')
require(quandmod)
